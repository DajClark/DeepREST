...
import NodeComponent from '@/entities/node/node.vue';
import NodeClass from '@/entities/node/node.component';
...
describe('Component Tests', () => {
  describe('Node Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<NodeClass>(NodeComponent, {
        store,
        i18n,
        localVue,
